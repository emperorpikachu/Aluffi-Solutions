...
make writing the proof quite more convenient.
\end{rem*}
\begin{xca*}
...
$A\subseteq C$ for any subsets $A,B,C$ of $S$. 
\end{sol*}
\begin{xca*}
...
on the trivial vector space $\{0\}$ which has dimension 0. 
\end{sol*}
\begin{xca*}
...
the morphism $\alpha\beta\gamma$. This completes the proof. 
