...
\documentclass[14pt,american]{extarticle}
...
%\usepackage{tgpagella} \usepackage[euler-digits]{eulervm}
...
\begin{document}
\title{Aluffi 2-1 solutions}
\author{Pika}

\maketitle
\include{macros}
\begin{xca*}
\cite[Ch-2, Ex-1.1]{aluffi} Prove that every group is the group of
isomorphisms of a groupoid. In particular, every group of automorphisms
of some object in some category. 
\end{xca*}
\begin{sol*}
\end{sol*}
